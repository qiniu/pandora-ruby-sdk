module Logdb
  module API
    ...
    module Utils
      ...
      #   Logdb::API.settings[:skip_parameter_validation] = true
      ...
      def __validate_and_extract_params(arguments, params=[], options={})
        if options[:skip_parameter_validation] || Logdb::API.settings[:skip_parameter_validation]
          arguments
        else
      ...
      def __report_unsupported_parameters(arguments, params=[])
        ...
        unsupported_params.each do |param|
          ...
          explanation = if param.is_a?(Hash)
            ...
            ". This parameter is not supported in the version you're using: #{Logdb::API::VERSION}, and will be removed in the next release."
          end
      ...
      def __report_unsupported_method(name)
        ...
        message += ". This method is not supported in the version you're using: #{Logdb::API::VERSION}, and will be removed in the next release."
