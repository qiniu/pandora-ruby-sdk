  ...
  module Transport
    module Transport
      module HTTP
        ...
        # @example HTTP
        #
        #     require 'pandora/transport/transport/http/manticore'
        #
        #     client = Pandora::Client.new transport_class: Pandora::Transport::Transport::HTTP::Manticore
        #
        ...
        #     require 'pandora/transport/transport/http/manticore'
        #
        #     client = Pandora::Client.new \
        #       url: 'https://pandora.example.com',
        #       transport_class: Pandora::Transport::Transport::HTTP::Manticore,
        #       ssl: {
