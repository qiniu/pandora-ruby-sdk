module Pandora
  module Transport
    ...
    # Handles communication with an Pandora cluster.
    #
    ...
    class Client
      ...
      DEFAULT_TRACER = lambda do
        require 'logger'
        logger = Logger.new(STDERR)
        logger.progname = 'pandora.tracer'
      ...
      #
      # @see Pandora::Transport::Transport::Base
      # @see Pandora::Transport::Transport::HTTP::Faraday
      #
      attr_accessor :transport

      # Create a client connected to an Pandora cluster.
      #
      # Specify the URL via arguments or set the `PANDORA_URL` environment variable.
      #
      ...
      #                                        {Pandora::Transport::Transport::Connections::Selector::Base}.
      #
      ...
      def initialize(arguments={}, &block)
        ...
        hosts = @arguments[:hosts] || \
                ...
                @arguments[:url]   || \
                @arguments[:urls]  || \
                ENV.fetch('PANDORA_URL', 'localhost:9188')
      ...
      def perform_request(method, path, params={}, body=nil, &block)
        ...
        transport.perform_request method, path, params, body, &block 
      end
      ...
      #
      # TODO: Refactor, so it's available in Pandora::Transport::Base as well
      #
      # @return [Array<Hash>]
      # @raise  [ArgumentError]
      #
