...
class Pandora::Transport::Transport::Connections::SelectorTest < Test::Unit::TestCase
  include Pandora::Transport::Transport::Connections::Selector

  class DummyStrategySelector
    include Pandora::Transport::Transport::Connections::Selector::Base
  end
