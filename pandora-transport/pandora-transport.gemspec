...
Gem::Specification.new do |s|
  s.name          = "pandora-transport"
  s.version       = Pandora::Transport::VERSION
  s.authors       = ["Kaixiong Ma"]
  s.email         = ["asce0705@gmail.com"]
  s.summary       = "Ruby client for Pandora Transport."
  s.homepage      = ""
  s.license       = "Apache 2"
  ...
  s.description = <<-DESC.gsub(/^    /, '')
    Ruby client for Pandora Transport. See the `pandora-transport` gem for full integration.
  DESC
end
